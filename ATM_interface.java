...
public class ATM_interface{
    public static void main(String[] args) {
        BankAccount ba = new BankAccount("Sonal Patil", "1234");
        ba.checkId();
    }
}
class BankAccount {
    ...
    public void transfer(double amount, BankAccount acc) {
        if (this.balance < amount) {
            ...
            this.balance -= amount;
            acc.balance += amount;
            System.out.println("Balance amount in " + this.customerName + " account is Rs." + this.balance);
            System.out.println("Balance amount in" + acc.customerName + " account is Rs." + acc.balance);
            System.out.println("\n");
        }
    }
        ...
        do {
            ...
            switch (option) {
                ...
                case '5':
                    ...
                    System.out.println("***************");
                    System.out.print("To ");
                    BankAccount bb = new BankAccount("Ram Patil", "1010");
